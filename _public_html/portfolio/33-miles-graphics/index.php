...
<body>  </div>
    ...
    <main class="site-content">
        ...
        <section class="section" style="padding-top: 140px; padding-bottom: 60px; text-align: center;">
            <div class="container" style="max-width: 800px;">
                ...
                <p class="reveal" style="font-size: 1.2rem; margin-top: 1.5rem;">
                    ...
                    a Christian band — social media graphics and event advertisement materials.
                </p>
            </div>
        </section>
        ...
        <section class="section-sm">
            <div class="container">
                ...
                <p class="reveal" style="text-align: center; color: var(--text-muted); margin-top: 40px;">
                    Click any design to view full size.
                </p>
            </div>
        </section>
        ...
        <section class="section-sm" style="text-align: center;">
            <div class="container">
                <a href="../professional-works/" class="btn btn-secondary">&#8592; Back to Professional Works</a>
            </div>
        </section>
