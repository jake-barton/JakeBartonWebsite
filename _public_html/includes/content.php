...
$content['featured_projects'] = [
    [
        ...
        'desc'     => '2D side-scrolling shooter — custom physics, 10+ weapons, procedural chunks, invincibility dash. Solo-developed, live on itch.io.',
        'cta'      => 'Play Now →',
        'badge'    => 'Featured',
    ...
    [
        ...
        'desc'     => 'Mode-7 SNES engine in vanilla JS — raycasting, sprite sheets, lap logic.',
        'cta'      => 'View →',
        'badge'    => '',
        'size'     => 'wide',
    ],
