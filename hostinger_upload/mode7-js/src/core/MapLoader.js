...
const MAPS = {
    marioCircuit: {
        name: 'Mario Circuit',
        paths: {
            track: 'assets/tracks/MarioCircuit/track.png',
            background: 'assets/tracks/MarioCircuit/background.png',
            trees: 'assets/tracks/MarioCircuit/background_trees.png',
            tiles: 'assets/tracks/MarioCircuit/mariocircuit_tiles.png',
            mask: 'assets/tracks/MarioCircuit/track copy.png'
        },
    }
};
