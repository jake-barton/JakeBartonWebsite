...
<head>
    ...
    <title>Manage Customers - Pi Kappa Phi Apparel</title>
    <?php csrfMetaTag(); ?>
    ...
    <script>
        ...
        function deleteCustomer(customerId, customerName) {
            if (confirm(`Are you sure you want to delete the account for ${customerName}?\n\nThis will permanently delete their account and all associated orders.`)) {
                ...
                form.method = 'POST';
                form.action = 'delete_customer.php';
        ...
        function viewCustomerOrders(customerId, customerName) {
            ...
            fetch(`get_customer_orders.php?customer_id=${encodeURIComponent(customerId)}`)
                ...
                .then(data => {
                    ...
                    if (data.orders && data.orders.length > 0) {
                        ...
                        data.orders.forEach(order => {
                            ...
                            const price = parseFloat(order.product_price).toFixed(2);
