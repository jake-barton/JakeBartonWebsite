...
function createCustomer($name, $email, $password) {
    ...
    $customer = [
        ...
        'verified' => true, // Auto-verify for easier access
    ...
    if (saveCustomers($customers)) {
        // Send verification email (optional - user can still login)
        sendVerificationEmail($email, $customer['verification_token'], $name);
        return ['success' => true, 'message' => 'Account created! You can now login and start ordering.'];
    }
...
function validateCustomerLogin($email, $password) {
    ...
    // Removed verification requirement - customers can login immediately
...
function sendPasswordResetEmail($email) {
    ...
    // Removed verification requirement for password reset
    // if (!$customer['verified']) {
